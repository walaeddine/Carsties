...
public class DbInitializer
{
    public static void InitDb(WebApplication app)
    {
        ...
        SeedDta(scope.ServiceProvider.GetService<AuctionDbContext>());
    }

    private static void SeedDta(AuctionDbContext context)
    {
